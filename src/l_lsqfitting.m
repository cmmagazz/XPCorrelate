%% Function to run some least squares fitting on declination angle vs H
%CMM 2019
...
text(55, 4, txt2);%, 'FontSize', 10, 'Color', 'k') 

legend({'Cosine Fit obtained','95% confidence interval'},'Location','northeast') 
hold off 
